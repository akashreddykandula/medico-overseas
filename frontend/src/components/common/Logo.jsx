  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <svg viewBox="0 0 64 64" className="h-full w-auto">
        ...
        <path d="M18 25 V36 C18 40 24 43 32 43 C40 43 46 40 46 36 V25" stroke="#FFFFFF" strokeWidth="2" fill="none" />
        <line x1="54" y1="22" x2="54" y2="34" stroke="#E15B3F" strokeWidth="2" />
      </svg>
