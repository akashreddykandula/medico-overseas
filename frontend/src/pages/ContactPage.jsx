...
const ContactPage = () => (
  <>
    <Helmet>
      ...
      <meta name="description" content="Get in touch with Medico Overseas for free MBBS abroad counselling. Call, WhatsApp, or visit our office." />
    </Helmet>

    <PageHero eyebrow="GET IN TOUCH" title="Contact Medico Overseas" subtitle="Talk to our counsellors about your MBBS abroad journey — no obligation, no pressure." />

    <div className="section-container grid grid-cols-1 gap-12 py-16 lg:grid-cols-3">
      <div className="space-y-8 lg:col-span-1">
        {[
          [HiLocationMarker, 'Office Address', '123 Education Tower, MG Road, Hyderabad, Telangana, India'],
